            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card mr-5" >
                <div class="card-body">
                  ...
                  @endif
                  <form class="forms-sample" action="/updateeventvrai/{{$data->nomevent}}" method="post">
                    @csrf
                    <div class="first" style="display: flex;">
                      ...
                      <div class="form-group w-50 ml-2">
                        ...
                        <select name="salle" class="form-control" id="exampleInputEmail1" required>
                            <option selected>{{$data->nomSalle}}</option>
                    ...
                    <div class="second" style="display: flex;">
                      ...
                      <div class="form-group w-50 ml-2">
                        ...
                        <input type="text" class="form-control" name="nomevent" id="exampleInputConfirmPassword1" value="{{$data->nomevent}}">
                      </div>
                    </div>
                    ...
                    <div class="second" style="display: flex;">
                      <div class="form-group w-50">
                        ...
                        <input type="time" class="form-control" name="debut" id="exampleInputPassword1" value="{{$data->tempsdebut}}">
                      </div>
                      <div class="form-group w-50 ml-2">
                        <label for="exampleInputConfirmPassword1">End Time </label>
                        <input type="time" class="form-control" name="fin" id="exampleInputConfirmPassword1" value="{{$data->tempsfin}}">
                      </div>
                    </div>
