                ...
                <div class="card-body ml-2" style="width: 800px;">
                  ...
                  <div class="table-responsive">
                        <form action="#" method="post">
                            ...
                            <p><img src="{{asset('phototerrain/'.$data->phototerrain)}}" style="width: 350px;" alt=""></p>
                            <label for="">N Terrain: </label>
                            <input type="text" value="{{$data->id}}" name="" id=""><br>
                            <label for="">Type:   </label>
                            <input type="text" value="{{$data->type}}" name="" id=""><br>
                            <label for="">Dimension:  </label>
                            <input type="text" value="{{$data->dimension}}" name="" id=""><br>
