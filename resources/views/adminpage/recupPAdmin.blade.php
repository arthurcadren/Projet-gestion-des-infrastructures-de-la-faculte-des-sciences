          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="../../images/infralog2.png" alt="logo">
              </div>
              <h4>Hello! let's get started</h4>
              <h6 class="font-weight-light">Modifier votre mot de passe</h6>
              <form class="pt-3" action="{{route('updatePAdminvrai')}}" method="post">
                @csrf
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="name"  id="exampleInputEmail1" placeholder="Username" required/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" name="verification"  id="exampleInputPassword1" placeholder="Password" required/>
                </div>
                <div class="mt-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="#">MODIFIER</button>
                </div>
