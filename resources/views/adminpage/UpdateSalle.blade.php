                ...
                <div class="card-body">
                  ...
                  <p class="card-description text-center">
                    Fill in the form to create a new class Room
                        ...
                        @endif
                  <form class="forms-sample" action="/updatedatavrai/{{$data->nomSalle}}" method="post">
                    @csrf
                    <div class="form-group">
                      <label for="exampleInputUsername1">Class Room Name</label>
                      <input type="text" class="form-control" name="noms" id="exampleInputUsername1" value="{{$data->nomSalle}}" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Capacity </label>
                      <input type="number" class="form-control" name="capacite" id="exampleInputEmail1" value="{{$data->capacite}}" required>
                    </div>
                    <div class="form-group">
