...
<html lang="en">
  <head>
    <title>Terrain reservation</title>
    <meta charset="utf-8">
             ...
             @foreach($terrains as $terrain)
					...
					<div class="col-md-4">
						<div class="car-wrap rounded ftco-animate">
							<div class="img rounded d-flex align-items-end" src="{{asset('phototerrain/'.$terrain->phototerrain)}}" style="background-image: url({{asset('phototerrain/'.$terrain->phototerrain)}});">
							</div>
							<div class="text">
								<h2 class="mb-0"><a href="car-single.html">{{ $terrain->id }}</a></h2>
								<div class="d-flex mb-3">
									<span class="cat">{{ $terrain->type }}</span>
									<p class="price ml-auto"><!--$500--> <span><!--/day--></span></p>
								</div>
								<p class="d-flex mb-0 d-block"> <a href="{{route('infoTsingle',['phototerrain'=>$terrain->phototerrain])}}" class="btn btn-secondary py-2 ml-1">Reserver</a></p>
							</div>
						</div>
					</div>
            @endforeach
