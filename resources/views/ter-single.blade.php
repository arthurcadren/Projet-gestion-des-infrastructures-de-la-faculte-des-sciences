      	...
      	<div class="row justify-content-center">
      		<div class="col-md-12">
      			<div class="car-details">
      				<div class="img rounded" style="background-image: url({{asset('phototerrain/'.$data->phototerrain)}});"></div>
      				<div class="text text-center">
      					<span class="subheading">Caracteristique</span>
      					<h2><!--Mercedes Grand Sedan--><input type="text" value="{{$data->id}}" name="" id=""><input type="text" value="{{$data->type}}" name="" id=""><input type="text" value="{{$data->dimension}}" name="" id="" selected><input type="text" value="{{$data->emplacement}}" name="" id=""><br><br></h2>
