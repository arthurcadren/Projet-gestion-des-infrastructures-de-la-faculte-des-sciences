...
<html lang="en">
  <head>
    <title>reservation de Vehicule</title>
    <meta charset="utf-8">
      	...
      	<div class="row justify-content-center">
      		<div class="col-md-12">
      			<div class="car-details">
      				<div class="img rounded" style="background-image: url({{asset('photovehicule/'.$data->photo)}});"></div>
      				<div class="text text-center">
      					<span class="subheading">Caracteristique</span>
      					<h2><!--Mercedes Grand Sedan--><input type="text" value="{{$data->marque}}" name="" id=""><input type="text" value="{{$data->couleur}}" name="" id=""><input type="text" value="{{$data->annee}}" name="" id="" selected><input type="text" value="{{$data->modele}}" name="" id=""><input type="text" value="{{$data->numero_plaque}}" name="" id=""><br><br></h2>
						  <p>Disponible :Lundi a Samedi </p>
                            <p>De:8h00 a 18h30</p>
