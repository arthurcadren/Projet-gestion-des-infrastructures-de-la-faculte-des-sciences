...
<html lang="en">
             ...
             @foreach($vehicules as $vehi)
					...
					<div class="col-md-4">
						<div class="car-wrap rounded ftco-animate">
							<div class="img rounded d-flex align-items-end" src="{{asset('photovehicule/'.$vehi->photo)}}" style="background-image: url({{asset('photovehicule/'.$vehi->photo)}});">
							</div>
							<div class="text">
								<h2 class="mb-0"><a href="car-single.html">{{ $vehi->numero_plaque }}</a></h2>
								<div class="d-flex mb-3">
									<span class="cat">{{ $vehi->marque }}</span>
									<p class="price ml-auto"><!--$500--> <span><!--/day--></span></p>
								</div>
								<p class="d-flex mb-0 d-block"><!--<a href="{{route('vinfoVehicule',['numplaque'=>$vehi->numero_plaque])}}" class="btn btn-primary py-2 mr-1">Info</a>--> <a href="{{route('infoVsingle',['numplaque'=>$vehi->numero_plaque])}}" class="btn btn-secondary py-2 ml-1">Reserver</a></p>
							</div>
						</div>
					</div>
            @endforeach
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with<!-- <i class="icon-heart color-danger" aria-hidden="true"></i>--> by <a href="https://colorlib.com" target="_blank">university of yaounde I</a>
