<!-- <html lang="en">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="maincss/font-awesome.css">
      <!-- Responsive-->
    ...
    <section class="vh-100"  >
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="card shadow-2-strong" style="border-radius: 1rem;">
                ...
                <div class="form-outline mb-4">
                    <input type="text" id="typePasswordX-2" class="form-control form-control-lg" required/>
                ...
                <a href="login.html">
                    <button class="btn btn-primary btn-lg btn-block" type="submit" style="background-color: #021239;">Sign Up</button>
                </a>
                
    
                <hr class="my-4">
    
                    <span>Already have an account?</span><a href="{{route('login')}}"><p>Login</p></a>
